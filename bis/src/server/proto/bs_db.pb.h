...
class MsgDbVersion : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:bs_czl.MsgDbVersion) */ {
 public:
  ...
  const ::std::string& save_time() const;
  void set_save_time(const ::std::string& value);
  #if LANG_CXX11
  void set_save_time(::std::string&& value);
  #endif
  void set_save_time(const char* value);
  void set_save_time(const void* value, size_t size);
  ::std::string* mutable_save_time();
  ::std::string* release_save_time();
  void set_allocated_save_time(::std::string* save_time);
 ...
 private:
  ...
  ::google::protobuf::internal::ArenaStringPtr save_time_;
  mutable int _cached_size_;
  friend struct protobuf_bs_5fdb_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class MsgDbKey : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:bs_czl.MsgDbKey) */ {
 public:
  ...
  double key(int index) const;
  void set_key(int index, double value);
  void add_key(double value);
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedField< double > key_;
...
#if LANG_CXX11
inline void MsgDbVersion::set_save_time(::std::string&& value) {
...
#endif
inline void MsgDbVersion::set_save_time(const char* value) {
...
inline void MsgDbVersion::set_save_time(const void* value, size_t size) {
...
inline ::std::string* MsgDbVersion::mutable_save_time() {
...
inline ::std::string* MsgDbVersion::release_save_time() {
...
inline void MsgDbVersion::set_allocated_save_time(::std::string* save_time) {
  if (save_time != NULL) {
...
inline double MsgDbKey::key(int index) const {
  // @@protoc_insertion_point(field_get:bs_czl.MsgDbKey.key)
  return key_.Get(index);
}
inline void MsgDbKey::set_key(int index, double value) {
  key_.Set(index, value);
  // @@protoc_insertion_point(field_set:bs_czl.MsgDbKey.key)
}
inline void MsgDbKey::add_key(double value) {
  key_.Add(value);
